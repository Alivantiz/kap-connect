...
/** Шестерня — с настоящими зубьями: радиальные штрихи читались как солнце. */
const IconGear = (p) => (
  <Svg {...p} sw={p.sw || 1.5}>
    <path d="M13.9 2.6h-3.8l-.4 2.3c-.6.2-1.1.5-1.6.8L5.9 4.8 4 8.1l1.8 1.5a7 7 0 0 0 0 1.9L4 13l1.9 3.3 2.2-.9c.5.3 1 .6 1.6.8l.4 2.3h3.8l.4-2.3c.6-.2 1.1-.5 1.6-.8l2.2.9L20 13l-1.8-1.5a7 7 0 0 0 0-1.9L20 8.1l-1.9-3.3-2.2.9c-.5-.3-1-.6-1.6-.8z" />
    <circle cx="12" cy="10.6" r="2.7" />
  </Svg>
)
...
/** Сварка: две пластины и шов между ними. */
const IconSpark = (p) => (
  <Svg {...p}>
    <path d="M3.4 6.8h17.2M3.4 17.2h17.2" />
    <path d="m4.4 12 2.5-2.8L9.4 12l2.5-2.8L14.4 12l2.5-2.8L19.4 12" />
  </Svg>
)
